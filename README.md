I completed this project in Google Cloud's BigQuery analytics platform. This project, challenged by Juan Martinez, was an exploratory analysis of the data set "Iowa Liquor Sales".
